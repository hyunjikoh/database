...
<TABLE BORDER='0' WIDTH='100%' ALIGN='CENTER' CELLSPACING='0' CELLPADDING='0'>
  ...
  <TR HEIGHT='30px' >
    <td width='100%' height='30' align='center' bgcolor='#DEB8B8'><font color='#FFFFFF'><button type="submit" value = "submit">변경</button></td>
  </form>
  
  <form action="adminprocess2.php" method="post">
  </TR>
  <TR HEIGHT='30px' >
  ...
  <TR HEIGHT='30px' >
    <td width='100%' height='30' align='center' bgcolor='#DEB8B8'><font color='#FFFFFF'><button type="submit" value = "submit">삭제</button></td>
  </form>
  </TR>
</TABLE>
</body>
